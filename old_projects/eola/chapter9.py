...
class IntroduceJennifer(JenniferScene):
    ...
    def how_we_label_her_basis(self):
        ...
        print self.b1_coords
        print self.b2_coords
...
class SpeakingDifferentLanguages(JenniferScene):
    def construct(self):
        ...
        for pi in jenny, you:
            pi.bubble = pi.get_bubble( width = 4.5, height = 3.5)
            if pi is you:
...
class JennysGrid(JenniferScene):
    def construct(self):
        ...
        bubble = self.jenny.get_bubble( width = 4)
        bubble.flip()
        bubble.set_fill(BLACK, opacity = 0.8)
        bubble.to_edge(LEFT)
        bubble.write("""
...
class RotationExample(LinearTransformationScene):
    ...
    def construct(self):
        ...
        coord_arrays = [i_coords,j_coords]
