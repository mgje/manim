...
class WhatIsA2DVector(LinearTransformationScene):
    ...
    def bring_in_students(self):
        ...
        bubble = cs_student.get_bubble(width = 4, height = 3)
...
class AskAbout4DPhysicsStudent(Scene):
    def construct(self):
        ...
        physy.bubble = physy.get_bubble( width = 5, height = 4.5)
...
class WhatIsSpace(Scene):
    def construct(self):
        ...
        compy.bubble = compy.get_bubble( width = 6, height = 4)
...
class TransformationsAndOperators(TeacherStudentsScene):
    def construct(self):
        ...
        bubble = teacher.get_bubble( height = 2, width = 2)
        bubble.set_fill(BLACK, opacity = 1)
        bubble.write("Yup!")
        self.play(
...
class FormalDefinitionOfLinear(LinearTransformationScene):
    ...
    def add_words(self):
        ...
        bubble = randy.get_bubble( width = 6, height = 4)
